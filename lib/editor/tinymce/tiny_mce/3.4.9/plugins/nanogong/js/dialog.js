...
var NanogongDialog = {
	...
	insert : function() {
        ...
        var r = tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<nanogong caption="'+form.caption.value+'" url = "'+ret+'"><img src="'+url+'/img/icon.gif" alt="sound" />'+form.caption.value+'&nbsp;</nanogong>');
